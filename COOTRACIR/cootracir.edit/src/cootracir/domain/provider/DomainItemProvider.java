...
/**
 * This is the item provider adapter for a {@link cootracir.domain.Domain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.DOMAIN__FACTORY_GESTION_HUMANA);
			childrenFeatures.add(DomainPackage.Literals.DOMAIN__FACTORY_GESTION_INVENTARIO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DOMAIN__FACTORY_GESTION_HUMANA,
				 DomainFactory.eINSTANCE.createFactoryGestionHumana()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.DOMAIN__FACTORY_GESTION_INVENTARIO,
				 DomainFactory.eINSTANCE.createFactoryGestionInventario()));
	}
