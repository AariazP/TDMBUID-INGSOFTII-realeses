 ...
 * </p>
 * <ul>
 *   <li>{@link cootracir.impl.ModelFactoryImpl#getTheDomain <em>The Domain</em>}</li>
 *   <li>{@link cootracir.impl.ModelFactoryImpl#getTheUI <em>The UI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelFactoryImpl extends EObjectImpl implements ModelFactory {
	...
	protected EClass eStaticClass() {
		return cootracirPackage.Literals.MODEL_FACTORY;
	}
	...
	public NotificationChain basicSetTheDomain(Domain newTheDomain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, cootracirPackage.MODEL_FACTORY__THE_DOMAIN, oldTheDomain, newTheDomain);
	...
	public void setTheDomain(Domain newTheDomain) {
		if (newTheDomain != theDomain) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, cootracirPackage.MODEL_FACTORY__THE_DOMAIN, newTheDomain, newTheDomain));
	}
	...
	public NotificationChain basicSetTheUI(UI newTheUI, NotificationChain msgs) {
		...
		theUI = newTheUI;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, cootracirPackage.MODEL_FACTORY__THE_UI, oldTheUI, newTheUI);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTheUI(UI newTheUI) {
		if (newTheUI != theUI) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, cootracirPackage.MODEL_FACTORY__THE_UI, newTheUI, newTheUI));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case cootracirPackage.MODEL_FACTORY__THE_DOMAIN:
				if (theDomain != null)
					msgs = ((InternalEObject)theDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - cootracirPackage.MODEL_FACTORY__THE_DOMAIN, null, msgs);
				return basicSetTheDomain((Domain)otherEnd, msgs);
			case cootracirPackage.MODEL_FACTORY__THE_UI:
				if (theUI != null)
					msgs = ((InternalEObject)theUI).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - cootracirPackage.MODEL_FACTORY__THE_UI, null, msgs);
