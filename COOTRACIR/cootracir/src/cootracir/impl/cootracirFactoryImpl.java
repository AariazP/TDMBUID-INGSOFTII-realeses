 ...
 * @generated
 */
public class cootracirFactoryImpl extends EFactoryImpl implements cootracirFactory {
	/**
	 ...
	 * @generated
	 */
	public static cootracirFactory init() {
		try {
			cootracirFactory thecootracirFactory = (cootracirFactory)EPackage.Registry.INSTANCE.getEFactory(cootracirPackage.eNS_URI);
			if (thecootracirFactory != null) {
				return thecootracirFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new cootracirFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case cootracirPackage.MODEL_FACTORY: return createModelFactory();
			default:
	 ...
	 * @generated
	 */
	public cootracirPackage getcootracirPackage() {
		return (cootracirPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static cootracirPackage getPackage() {
		return cootracirPackage.eINSTANCE;
	}

} //cootracirFactoryImpl
